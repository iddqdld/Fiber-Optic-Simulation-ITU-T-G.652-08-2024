...
export function drawPandaMesh(
  ...
  const pathProject = canTransform
  ...
  const lineFactor = canTransform ? scale * view.zoom : 1
  context.fillStyle = '#1d2b38'
  drawRetainedPath(context, geometry.regionPaths.cladding, pathProject, 'fill')
  context.fillStyle = '#276f8e'
  drawRetainedPath(context, geometry.regionPaths.core, pathProject, 'fill')
  context.fillStyle = '#917035'
  drawRetainedPath(context, geometry.regionPaths.sap_1, pathProject, 'fill')
  context.fillStyle = '#5d7d4c'
  drawRetainedPath(context, geometry.regionPaths.sap_2, pathProject, 'fill')
  context.strokeStyle = '#617385'
  context.lineWidth = 0.35 / lineFactor
  drawRetainedPath(context, geometry.allEdges, pathProject, 'stroke')
  context.strokeStyle = '#d8edf7'
  context.lineWidth = 1.1 / lineFactor
  drawRetainedPath(context, geometry.interfaceEdges, pathProject, 'stroke')
  context.strokeStyle = '#f2f7fb'
  context.lineWidth = 1.6 / lineFactor
  drawRetainedPath(context, geometry.outerEdges, pathProject, 'stroke')
  context.restore()
}
