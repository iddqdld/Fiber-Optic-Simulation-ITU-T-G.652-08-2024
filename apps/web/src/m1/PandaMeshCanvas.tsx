  ...
  return (
    <figure className="panda-mesh-figure" aria-labelledby={captionId}>
      <div className="panda-mesh-plot-heading">
        ...
        <span>Level {result.configuration.refinement_level}</span>
      </div>
      ...
      <div className="panda-mesh-controls" aria-label="Mesh view controls">
        ...
        <label htmlFor={zoomId}>Mesh zoom</label>
        <input
          id={zoomId}
          type="range"
          min={MESH_ZOOM_MIN}
      ...
      <p className="panda-mesh-control-help">
        Drag to pan. Use the wheel, buttons, or keyboard. Use +/− to zoom, 0 to
        reset, and arrow keys to pan.
      </p>
      ...
      <figcaption id={captionId}>
        Mesh preview with no solved FEM fields. Full FEM fields appear only
        after Calculate FEM.
      </figcaption>
    </figure>
  )
